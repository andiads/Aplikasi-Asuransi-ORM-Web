            ...
            <div class="container-fluid">
               ...
               <%
                ...
                <form name="formupdate" action="updateasuransi" method="POST">
                    ...
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Jenis Asuransi</label>
                        <input class="form-control" name="jenisasuransi" type="text" 
                                           value="<%= a.getJenisAsuransi()%>"     ></div>
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Masa Berlaku</label>
                       <input class="form-control" name="masaberlaku" type="text" 
                                           value="<%= a.getMasaBerlaku()%>"     ></div>
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Bunga</label>
                         <input class="form-control" name="bunga" type="text" 
                                           value="<%= a.getBunga()%>"     ></div>
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Nomor Telpon</label>
                        <input class="form-control" name="pembayaran/bulan" type="text" 
                                           value="<%= a.getJmlBayar()%>"     ></div>
