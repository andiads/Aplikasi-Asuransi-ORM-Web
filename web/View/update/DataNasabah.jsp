        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <%
                    ...
                    String tgl = dateFormat.format(nasabah.getTglLahir());
                ...
                <form name="formupdate" action="updatenasabah" method="POST">
                    ...
                    <div class="form-group has-success">
                        ...
                        <% }%></div>
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Penghasilan / Bulan</label>
                        <input class="form-control" name="penghasilan" type="text" 
                               value="<%= nasabah.getPengBulan()%>"     ></div>
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Admin</label>
                        <select name="idadmin">                                                                                                      
                            <% List<Object> admin = new AdminDAO().getAll();
                                for (Object elem : admin) {
                                    Admin a = (Admin) elem;
                                    if (nasabah.getIdAdmin().getIdAdmin().equals(a.getIdAdmin())) {%>
                            <option value="<%= a.getIdAdmin()%>" selected><%= a.getIdAdmin() + " " + a.getNamaAdmin()%></option>
                            <%  } else {%>                                    
                            <option value="<%= a.getIdAdmin()%>"><%= a.getIdAdmin() + " " + a.getNamaAdmin()%></option>
                            <%   }
