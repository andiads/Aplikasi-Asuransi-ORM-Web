    ...
    <div class="container-fluid">
                ...
                <form name="formupdate" action="fixupdate" method="POST">
                    ...
                    <div class="form-group has-success">
                        ...
                        <input class="form-control" name="namaAdmin" type="text" value="<%= a.getNamaAdmin()%>"     ></div>
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Alamat</label>
                       <<input class="form-control" name="alamat" type="text" value="<%= a.getAlamat()%>"></div>
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Email</label>
                        <input class="form-control" name="email" type="email" value="<%= a.getEmail()%>"></div>
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Nomor Telpon</label>
                        <input class="form-control" name="noTelp" type="text" value="<%= a.getNoTelp()%>"></div>
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Password</label>
                        <input class="form-control" name="pass" type="text" value="<%= a.getPassword()%>"></div>
