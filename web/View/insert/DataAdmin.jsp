    ...
    <div class="container-fluid">
                ...
                <form name="formupdate" action="${pageContext.request.contextPath}/admini" method="POST">
                    ...
                    <div class="form-group has-success">
                        ...
                        <input class="form-control" name="namaAdmin" type="text" value=""     ></div>
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Alamat</label>
                       <input class="form-control" name="alamat" type="text" value=""></div>
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Email</label>
                         <input class="form-control" name="email" type="email" value=""></div>
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Nomor Telpon</label>
                        <input class="form-control" name="noTelp" type="text" value=""></div>
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Password</label>
                        <input class="form-control" name="pass" type="text" value=""></div>
