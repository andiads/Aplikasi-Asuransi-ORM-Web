                    ...
                    <div class="container-fluid">
                        ...
                        <div class="panel panel-headline">
                            <div class="panel-heading">
                                <h3 class="panel-title">TAMBAH DATA KLAIM</h3>
                            </div>
                            <%

                                String klaim = (String) session.getAttribute("autoIDKlaim");
                            %>
                            <form name="formupdate" action="klaiminsert" method="POST">

                                <div class="form-group">
                                    <label>ID Klaim </label>
                                    <input class="form-control" name="idKlaim" type="text" value="<%=klaim%>">
                                </div>
                                <div class="form-group">
                                    <label>No Polis</label>
                                    <input class="form-control" name="noPolis" type="text" value=""     >
                                </div>
                                <div class="form-group">
                                    <label>Kode Asuransi</label>
                                    <!--<input class="form-control" name="kodeAsuransi" type="text" value=""     >-->
                                    <select name="kdasuransi">
                                        ...
                                        <option value="<%= asuransi.getKodeAsuransi()%>">
                                            ...
                                            <%=asuransi.getJenisAsuransi()%></option>
                                            <%
                                                }
                                            %>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="tglKlaim" type="date" value=""     >
                                </div>
