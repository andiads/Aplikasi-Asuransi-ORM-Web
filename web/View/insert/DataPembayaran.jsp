...
<html>
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
            <a class="navbar-brand" href="<%=session.getAttribute("err")%>&password=<%=session.getAttribute("pass")%>">Start Bootstrap</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
                        <a class="nav-link" href="<%=session.getAttribute("err")%>&password=<%=session.getAttribute("pass")%>">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
              ...
              <%
                                ...
                                DetailNasabah nopolis = (DetailNasabah) session.getAttribute("nopolis");
                ...
                <form name="formupdate" action="pembayaraninsert" method="POST">
                    ...
                    <div class="form-group has-success">
                        ...
                        <input class="form-control" name="nmrpolis" type="text" readonly="true" value="<%=nopolis.getNoPolis()%>"     ></div>
                   
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Nama Nasabah :</label>
                        <input class="form-control" name="namanasabah" readonly="true" type="text" value="<%=nopolis.getNoPolis().getNmNasabah()%>"     ></div>
                    <div class="form-group has-success">
                    <div class="form-groupLogoutServlet has-success">
                        <label class="control-label" for="inputSuccess">Kode Asuransi :</label>
                        <input class="form-control" name="kodeasuransi" readonly="true" type="text" value="<%=nopolis.getKodeAsuransi()%>"     ></div>
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Asuransi :</label>
                        <input class="form-control" name="namanasabah" readonly="true" type="text" value="<%=nopolis.getKodeAsuransi().getJenisAsuransi()%>"     ></div>
                    <div class="form-group has-success">
                    ...
                    <div class="form-group has-success">
                        <label class="control-label" for="inputSuccess">Jumlah Pembayaran</label>
                       
                        <input class="form-control" name="jmlbayar" type="text" readonly="true" value="<%=nopolis.getKodeAsuransi().getJmlBayar()%>"     ></div>
