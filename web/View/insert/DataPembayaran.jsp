                    ...
                    <div class="container-fluid">
                        ...
                        <div class="panel panel-headline">
                            ...
                            <%
                                ...
                                String nopolis = (String) session.getAttribute("nopolis");
                            %>
                            <form name="formupdate" action="pembayaraninsert" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="nmrpolis" type="text" value="<%=nopolis%>"     >
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                    <label>Saldo</label>
                                    <input class="form-control" name="Saldo" type="text" value=""     >
