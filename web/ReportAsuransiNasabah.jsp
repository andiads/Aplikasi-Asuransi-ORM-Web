<%-- 
    Document   : ReportAsuransiNasabah
    Created on : Apr 26, 2018, 8:47:15 AM
    Author     : Toshiba
--%>
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <!-- Icon Cards-->
                <form action="CetakAsuransiNasabah.jsp" target="_blank">
                    <div>
                        <div class="form-group has-success">
                        <label class="control-label" >No Polis </label>
                        <input class="input" name="kategory" type="text">
                        <!--                    </div>
                                                Masukan No Polis : <input type="input" name="kategory" type="text" >
                                                <button type="submit" class="btn btn-default" value="submit" target="_blank">Cetak</button>-->
                         <button type="submit" class="btn btn-default"  value="submit" target="_blank">Cetak</button>
                    </div>
                </form>
                <!-- Example Social Card-->
